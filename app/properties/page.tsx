...
export default function PropertiesPage() {
  ...
  const fetchProperties = async () => {
    try {
      ...
      const formattedProperties: Property[] = data.map((property) => ({
        ...
        images: property.images || [property.image], // Use images array or fallback to single image
        type: property.type,
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-4 text-slate-900">All Properties</h1>
        <p className="text-slate-600">Discover your perfect property from our extensive collection</p>
      </div>
      ...
      <div className={viewMode === "grid" ? "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" : "space-y-6"}>
        {properties.map((property) => (
          <Card
            key={property.id}
            className={`overflow-hidden transition-all duration-300 hover:-translate-y-1 bg-white border-0 rounded-2xl ${
          ...
          >
            <div className={`${viewMode === "list" ? "w-1/3" : "relative"} overflow-hidden`}>
              <Image
                ...
                className={`object-cover transition-transform duration-300 hover:scale-105 ${
                  viewMode === "list" ? "w-full h-full rounded-l-2xl" : "w-full h-48 rounded-t-2xl"
                }`}
              />
                ...
                <Badge
                  ...
                  className={
                    property.status === "For Sale"
                      ? "bg-primary hover:bg-primary/90 text-white shadow-lg rounded-full px-3 py-1"
            ...
            <div className={viewMode === "list" ? "flex-1" : ""}>
              <CardContent className="p-6">
                ...
                <h3 className="font-semibold text-lg mb-2 text-slate-900 line-clamp-2">{property.title}</h3>
              ...
              <CardFooter className="p-6 pt-0">
                ...
                >
                  <DialogTrigger asChild>
                    <Button
                      className="w-full bg-primary hover:bg-primary/90 text-white rounded-xl py-2.5 font-medium"
                      onClick={() => {
